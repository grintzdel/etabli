...
export class BookingHttpAdapter implements IBookingPort {
  ...
  checkIn(id: string, checkInToken: string): Promise<BookingResult<BookingDetail>> {
    return this.authenticated.post<BookingDetail>(buildPath(routes.bookings.checkIn, { id }), { checkInToken })
  }
}
